...
大牌宠粉礼，11.11钜惠购
11.8 - 11.30
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=dzdnwmqr20211108A&shareUuid=d56c22cfa3704079a08d1cfe9bfa1f46

默认执行脚本。如果需要不执行
环境变量 NO_RUSH=false
*/
const $ = new Env("11.8 - 11.30 大牌宠粉礼，11.11钜惠购");
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/opencard14.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            'd56c22cfa3704079a08d1cfe9bfa1f46',
        ]
    }
