...
[task_local]
#联合开卡
20 3,19 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_opencardDP12.js, tag=联合开卡, enabled=true

*/
const $ = new Env("大牌联合开卡");
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/opencard.json')
