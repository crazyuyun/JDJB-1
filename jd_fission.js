...
cron 47 0,9 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_fission.js
* */
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/KingRan/JDJB/main/shareCodes/qjd.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/qjd.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res.length > 0){
