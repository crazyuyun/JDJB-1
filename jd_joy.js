...
[task_local]
#京东宠汪汪
17 1,12 * * * jd_joy.js, tag=京东宠汪汪, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

============Loon===========
[Script]
cron "17 1,12 * * *" script-path=jd_joy.js,tag=京东宠汪汪

============Surge==========
[Script]
京东宠汪汪 = type=cron,cronexp="17 1,12 * * *",wake-system=1,timeout=3600,script-path=jd_joy.js

===============小火箭==========
京东宠汪汪 = type=cron,script-path=jd_joy.js, cronexpr="17 1,12 * * *", timeout=3600, enable=true
