...
cron:47 4,12 3-12 12 *
============Quantumultx===============
[task_local]
#12.3~12.12 12.12 好物狂欢盛典
47 4,12 3-12 12 * https://raw.githubusercontent.com/smiek2121/scripts/master/gua_opencard76.js, tag=12.3~12.12 12.12 好物狂欢盛典, enabled=true
...
let activityCookie =''
!(async () => {
  console.log('添加瓜佬开卡脚本，请在配置文件填入下方所有变量')
  console.log('export guaopencard_All="true" # 青蛙开卡总开关')
  console.log('export guaopencard_addSku_All="false" # 青蛙开卡加购')
  console.log('export guaopencardRun_All="true" # 青蛙开卡做任务')
  console.log('export guaopencard_draw="true" # 青蛙开卡抽奖')
  if ($.isNode()) {
    if(guaopencard+"" != "true"){
  ...
  $.shareUuid = "b83729c4ba70485e9e796249fc150ef6"
