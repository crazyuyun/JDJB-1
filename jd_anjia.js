/*
安佳组队活动
地址：https://lzkjdz-isv.isvjcloud.com/pool/captain/1313?activityId=e30b75bc00ce40b394da416c921fea66
18 0,12 * * * jd_anjia.js
*/
const $ = new Env("安佳组队活动瓜分京豆");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '202e13525a3747e282ce0983f20afc9b',
            ]
            $.bean = 0;
